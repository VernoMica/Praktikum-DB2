    ...
    <main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-32">
                <img src="{{ $event->poster_path ? (Str::startsWith($event->poster_path, 'http') ? $event->poster_path : asset('storage/' . $event->poster_path)) : 'https://placehold.co/600x800?text=' . urlencode($event->title) }}" alt="{{ $event->title }}"
                ...
                <div class="mt-8 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Penyelenggara Terverifikasi</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 space-y-12">
            <div class="space-y-4">
                ...
                <h1 class="text-4xl md:text-5xl font-black leading-tight text-slate-800">{{ $event->title }}</h1>
            ...
            <div class="prose prose-slate max-w-none">
                <h3 class="text-2xl font-bold text-slate-800 mb-4">Deskripsi Event</h3>
