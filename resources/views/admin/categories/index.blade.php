...
@section('header_left')
    ...
    <p class="text-slate-500 font-medium">Atur kategori untuk event-event Anda.</p>
@endsection
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="bg-white px-8 pt-8 pb-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-2xl font-black text-slate-800" id="modal-title">Tambah Kategori</h3>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name" required placeholder="Masukkan nama kategori (contoh: Workshop)"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="relative inline-block align-bottom bg-white rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-slate-100">
            <form id="editForm" method="POST">
                ...
                <div class="bg-white px-8 pt-8 pb-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-2xl font-black text-slate-800" id="modal-title">Edit Kategori</h3>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="edit_name" class="block text-sm font-bold text-slate-700 mb-2">Nama Kategori</label>
                            <input type="text" name="name" id="edit_name" required placeholder="Masukkan nama kategori"
                                class="w-full px-5 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm text-slate-800">
                        </div>
                    </div>
                </div>
