...
class CheckoutController extends Controller
{
    ...
    public function store(Request $request, Event $event)
    {
        ...
        // 4. Merekam Transaksi ke Database terlebih dahulu
        ...
        try {
            ...
            // Jika Midtrans gagal, hapus transaksi dan kembalikan stok
            $transaction->delete();
            ...
            if ($status) {
                ...
                if (in_array($trx_status, ['settlement', 'capture'])) {
                    ...
                    if (strtolower($transaction->status) === 'pending') {
                        ...
                        // Stok sudah dikurangi saat store(), tidak perlu dikurangi lagi di sini
                        try {
